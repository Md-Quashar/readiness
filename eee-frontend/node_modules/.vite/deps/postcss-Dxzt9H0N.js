...
var require_stringifier = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var Stringifier = class {
		...
		block(node, start) {
			...
			} else after = typeof raws.after !== "undefined" ? raws.after : this.raw(node, "after", "emptyBody");
		...
		body(node) {
			...
			for (let i = 0; i < nodes.length; i++) {
				...
				if (typeof before === "undefined") before = this.raw(child, "before");
...
//# sourceMappingURL=postcss-Dxzt9H0N.js.map