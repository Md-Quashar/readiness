import { i as __toESM$1, t as __commonJSMin$1 } from "./chunk-C-Qwzh9l.js";
import { t as require_browser_external_node_path } from "./browser-external_node_path-BCPQ3bxh.js";
import { t as require_browser_external_node_module } from "./browser-external_node_module-Bw84UBiY.js";
import { t as require_promises } from "./promises-D7loALU_.js";
import { n as require_browser_external_node_process, t as require_browser_external_node_tty } from "./browser-external_node_tty-twjreviz.js";
//#region node_modules/rolldown/dist/shared/binding-BeU_1iEk.mjs
...
//#endregion
//#region node_modules/rolldown/dist/shared/logs-D80CXhvg.mjs
...
//#endregion
//#region node_modules/rolldown/dist/shared/normalize-string-or-regex-CbQQ69gT.mjs
...
//#endregion
//#region node_modules/rolldown/dist/shared/misc-DJYbNKZX.mjs
...
function noop(..._args) {}
//#endregion
//#region node_modules/rolldown/dist/shared/error-DL-e8-oE.mjs
...
//#endregion
//#region node_modules/rolldown/dist/shared/parse-B_ZnWxLZ.mjs
...
async function parse(filename, sourceText, options) {
	return wrap$1(await (0, import_binding$2.parse)(filename, sourceText, options));
}
/**
...
function parseSync(filename, sourceText, options) {
	return wrap$1((0, import_binding$2.parseSync)(filename, sourceText, options));
}
//#endregion
...
//#endregion
//#region node_modules/rolldown/node_modules/@rolldown/pluginutils/dist/filter/composable-filters.js
var And = class {
	kind;
	args;
	constructor(...args) {
...
//#endregion
//#region node_modules/rolldown/dist/shared/bindingify-input-options-DbbBhzky.mjs
...
Object.defineProperty(import_binding$1.BindingMagicString.prototype, "isRolldownMagicString", {
	value: true,
	writable: false,
	configurable: false
});
...
var nativeAppend = import_binding$1.BindingMagicString.prototype.append;
var nativePrepend = import_binding$1.BindingMagicString.prototype.prepend;
var nativeAppendLeft = import_binding$1.BindingMagicString.prototype.appendLeft;
var nativeAppendRight = import_binding$1.BindingMagicString.prototype.appendRight;
var nativePrependLeft = import_binding$1.BindingMagicString.prototype.prependLeft;
var nativePrependRight = import_binding$1.BindingMagicString.prototype.prependRight;
var nativeOverwrite = import_binding$1.BindingMagicString.prototype.overwrite;
var nativeUpdate = import_binding$1.BindingMagicString.prototype.update;
import_binding$1.BindingMagicString.prototype.append = function(content) {
	assertString(content, "outro content must be a string");
	return nativeAppend.call(this, content);
};
import_binding$1.BindingMagicString.prototype.prepend = function(content) {
	assertString(content, "outro content must be a string");
	return nativePrepend.call(this, content);
};
import_binding$1.BindingMagicString.prototype.appendLeft = function(index, content) {
	assertString(content, "inserted content must be a string");
	return nativeAppendLeft.call(this, index, content);
};
import_binding$1.BindingMagicString.prototype.appendRight = function(index, content) {
	assertString(content, "inserted content must be a string");
	return nativeAppendRight.call(this, index, content);
};
import_binding$1.BindingMagicString.prototype.prependLeft = function(index, content) {
	assertString(content, "inserted content must be a string");
	return nativePrependLeft.call(this, index, content);
};
import_binding$1.BindingMagicString.prototype.prependRight = function(index, content) {
	assertString(content, "inserted content must be a string");
	return nativePrependRight.call(this, index, content);
};
import_binding$1.BindingMagicString.prototype.overwrite = function(start, end, content, options) {
	assertString(content, "replacement content must be a string");
	return nativeOverwrite.call(this, start, end, content, options);
};
import_binding$1.BindingMagicString.prototype.update = function(start, end, content, options) {
	assertString(content, "replacement content must be a string");
	return nativeUpdate.call(this, start, end, content, options);
};
var nativeReplace = import_binding$1.BindingMagicString.prototype.replace;
var nativeReplaceAll = import_binding$1.BindingMagicString.prototype.replaceAll;
import_binding$1.BindingMagicString.prototype.replace = function(searchValue, replacement) {
...
import_binding$1.BindingMagicString.prototype.replaceAll = function(searchValue, replacement) {
...
* @experimental
*/
var RolldownMagicString = import_binding$1.BindingMagicString;
...
function bindingPluginOrder(order) {
	switch (order) {
		case "post": return import_binding$1.BindingPluginOrder.Post;
		case "pre": return import_binding$1.BindingPluginOrder.Pre;
		case null:
		case void 0: return;
...
function bindingifyAttachDebugInfo(attachDebugInfo) {
	switch (attachDebugInfo) {
		case void 0: return;
		case "full": return import_binding$1.BindingAttachDebugInfo.Full;
		case "simple": return import_binding$1.BindingAttachDebugInfo.Simple;
		case "none": return import_binding$1.BindingAttachDebugInfo.None;
	}
}
...
function bindingifyExperimental(experimental) {
	let chunkModulesOrder = import_binding$1.BindingChunkModuleOrderBy.ExecOrder;
	if (experimental?.chunkModulesOrder) switch (experimental.chunkModulesOrder) {
		case "exec-order":
			chunkModulesOrder = import_binding$1.BindingChunkModuleOrderBy.ExecOrder;
			break;
		case "module-id":
			chunkModulesOrder = import_binding$1.BindingChunkModuleOrderBy.ModuleId;
			break;
...
function bindingifyLogLevel(logLevel) {
	switch (logLevel) {
		case "silent": return import_binding$1.BindingLogLevel.Silent;
		case "debug": return import_binding$1.BindingLogLevel.Debug;
		case "warn": return import_binding$1.BindingLogLevel.Warn;
		case "info": return import_binding$1.BindingLogLevel.Info;
...
function bindingifyTreeshakeOptions(config) {
	...
	switch (config.propertyReadSideEffects) {
		case "always":
			normalizedConfig.propertyReadSideEffects = import_binding$1.BindingPropertyReadSideEffects.Always;
			break;
		case false:
			normalizedConfig.propertyReadSideEffects = import_binding$1.BindingPropertyReadSideEffects.False;
			break;
		default:
	}
	switch (config.propertyWriteSideEffects) {
		case "always":
			normalizedConfig.propertyWriteSideEffects = import_binding$1.BindingPropertyWriteSideEffects.Always;
			break;
		case false:
			normalizedConfig.propertyWriteSideEffects = import_binding$1.BindingPropertyWriteSideEffects.False;
			break;
		default:
	}
...
//#endregion
//#region node_modules/rolldown/dist/shared/rolldown-build-DSxL8qiP.mjs
...
isTypeTrue();
var JsxOptionsSchema = /* @__PURE__ */ strictObject({
...
isTypeTrue();
var HelperModeSchema = /* @__PURE__ */ union([/* @__PURE__ */ literal("Runtime"), /* @__PURE__ */ literal("External")]);
var DecoratorOptionSchema = /* @__PURE__ */ object({
	legacy: /* @__PURE__ */ optional(/* @__PURE__ */ boolean()),
	emitDecoratorMetadata: /* @__PURE__ */ optional(/* @__PURE__ */ boolean())
});
isTypeTrue();
var HelpersSchema = /* @__PURE__ */ object({ mode: /* @__PURE__ */ optional(HelperModeSchema) });
isTypeTrue();
var TypescriptSchema = /* @__PURE__ */ object({
...
isTypeTrue();
var AssumptionsSchema = /* @__PURE__ */ object({
...
isTypeTrue();
var TransformPluginsSchema = /* @__PURE__ */ object({
...
isTypeTrue();
var CompressTreeshakeOptionsSchema = /* @__PURE__ */ strictObject({
...
isTypeTrue();
var CompressOptionsSchema = /* @__PURE__ */ strictObject({
...
isTypeTrue();
var MangleOptionsKeepNamesSchema = /* @__PURE__ */ strictObject({
	function: /* @__PURE__ */ boolean(),
	class: /* @__PURE__ */ boolean()
});
isTypeTrue();
var MangleOptionsSchema = /* @__PURE__ */ strictObject({
...
isTypeTrue();
var CodegenOptionsSchema = /* @__PURE__ */ strictObject({ removeWhitespace: /* @__PURE__ */ optional(/* @__PURE__ */ boolean()) });
isTypeTrue();
...
isTypeTrue();
var GeneratedCodePresetSchema = /* @__PURE__ */ union([/* @__PURE__ */ literal("es5"), /* @__PURE__ */ literal("es2015")]);
isTypeTrue();
...
function createConsola(options = {}) {
	...
	return createConsola$1({
		...
		prompt: (...args) => import("./prompt-U5ajztzG-udO30vyT.js").then((m) => m.prompt(...args)),
...
//#endregion
export { makeBuiltinPluginCallable as C, require_binding as D, __toESM as E, BuiltinPlugin as S, logMultipleWatcherOption as T, normalizeBindingError as _, require_browser_external_node_os as a, arraify as b, LOG_LEVEL_WARN as c, parseAst as d, parseAstAsync as f, bindingifySourcemap$1 as g, aggregateBindingErrorsIntoJsError as h, validateOption as i, VERSION as l, parseSync as m, RolldownBuild as n, require_browser_external_node_util as o, parse as p, createBundlerOptions as r, require_browser_external_node_worker_threads as s, PluginDriver as t, transformToRollupOutput as u, normalizeBindingResult as v, normalizedStringOrRegex as w, isPromiseLike as x, unwrapBindingResult as y };

//# sourceMappingURL=rolldown-build-DSxL8qiP-CpYWo46V.js.map